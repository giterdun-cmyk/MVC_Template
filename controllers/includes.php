...
// Create a constant variable to hold the path tp the root directory of the project
...
spl_autoload_register(function($class){
    // $class = User
    // add any .php file extensions with the class name to match, but must be lower case
